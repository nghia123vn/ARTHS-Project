                        ...
                        <div className="font-semibold text-[20px] flex space-x-4 items-center pt-3">
                            {data?.status === statusOrder.Processing
                                ? (
                                    ...
                                    <Link to="/manage-orders-owner/online-order/list-order-finish" className="hover:text-main">Lịch sử đơn hàng</Link>
                                ) : data?.status === statusOrder.Canceled ? (
                                    <Link to="/manage-orders-owner/online-order/list-order-canceled" className="hover:text-main">Đơn hàng đã hủy</Link>
...
export default DetailOnlineOrderOwner