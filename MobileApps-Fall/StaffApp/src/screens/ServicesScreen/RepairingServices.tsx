...
export const RepairingServicesScreen = memo(function RepairingServicesScreen() {
  const listOrders = useOrderByQuery(EOrderStatus.Repairing);
  ...
  const handleLoadMore = useCallback(async () => {
    ...
    await requestLoadMoreOrders({
      ...
      orderStatus: EOrderStatus.Repairing
    });
  }, [pageNumber]);
